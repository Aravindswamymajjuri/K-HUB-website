...
const renderInternships = () => (
  <div className="internships-page">
    <header className="header internship-header">
  ...
  const renderInternshipDetails = () => (
    <div className="container">
      <header className="header internship-details-header">
        <button onClick={handleBack} className="back-btn details-back-btn">
          ← Back to Internships
        </button>
        ...
        <div className="info-section">
          ...
          <table className="internship-table">
            <tbody>
              <tr>
                <th>Title</th>
                <td>{selectedInternship.internshipTitle}</td>
              </tr>
              <tr>
                <th>Company</th>
                <td>{selectedInternship.company}</td>
              </tr>
              <tr>
                <th>Duration</th>
                <td>{selectedInternship.duration}</td>
              </tr>
              <tr>
                <th>Batch</th>
              ...
              <tr>
                <th>Created</th>
                <td>{new Date(selectedInternship.createdAt).toLocaleString()}</td>
              </tr>
              <tr>
                <th>Updated</th>
                <td>{new Date(selectedInternship.updatedAt).toLocaleString()}</td>
              </tr>
              {selectedInternship.description && (
                <tr>
                  <th>Description</th>
                  <td>{selectedInternship.description}</td>
                </tr>
              )}
