...
const Project = require('./routes/projectlink'); // Assuming you have a Project model defined
const Intership = require('./routes/intership'); // Assuming you have an Intership model defined
const app = express();
...
app.use('/api/interships', Intership);
